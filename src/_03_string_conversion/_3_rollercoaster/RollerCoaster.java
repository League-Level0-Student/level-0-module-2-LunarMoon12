...
public class RollerCoaster {
	...
	public static void main(String args[]) {
		...
		String heightToRide = JOptionPane.showInputDialog("What height in inches are you?");
		...
		// JoptionPane
		if (heightAsInt >= 48) {
			System.out.print("You are tall enough to ride the coaster alone!");
		}
		...
		// coaster pal!"
			...
			System.out.print("You must be at least 42 inches tall to ride the coaster pal!");
	}
}
